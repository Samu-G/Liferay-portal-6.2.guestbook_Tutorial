...
//Searching need an indexer class use to index, based on two basis info: the Class name to index, the porlet id.
public class EntryIndexer extends BaseIndexer {

	public static final String[] CLASS_NAMES = { Entry.class.getName() };

	public static final String PORTLET_ID = "guestbook-list-controller";
